  ...
  categories = [
    {
      id: "1",
      name: "Furniture",
      icon: "https://images.unsplash.com/photo-1540574163026-643ea20ade25?w=300&q=80",
      color: "bg-amber-100",
    ...
    },
    {
      id: "2",
      name: "Lighting",
      icon: "https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=300&q=80",
      color: "bg-blue-100",
    ...
    },
    {
      id: "3",
      name: "Decor",
      icon: "https://images.unsplash.com/photo-1594040226829-7f251ab46d80?w=300&q=80",
      color: "bg-rose-100",
      url: "/category/decor",
    },
    {
    ...
    },
    {
      id: "7",
      name: "Bedroom",
      icon: "https://images.unsplash.com/photo-1583845112203-29329902332e?w=300&q=80",
      color: "bg-indigo-100",
    ...
    },
    {
      id: "8",
      name: "Smart Home",
      icon: "https://images.unsplash.com/photo-1621274147744-cfb5753dfe1f?w=300&q=80",
      color: "bg-cyan-100",
